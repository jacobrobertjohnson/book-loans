        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthorEntity = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    Edition = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    YearFirstPublished = table.Column<int>(type: "INTEGER", nullable: false),
                    YearEditionPublished = table.Column<int>(type: "INTEGER", nullable: true),
                    Isbn = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
                    DateOfPurchase = table.Column<DateOnly>(type: "TEXT", nullable: true),
                    LocationOfPurchase = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Books_YearEditionPublished", "\"YearEditionPublished\" IS NULL OR (\"YearEditionPublished\" >= 1000 AND \"YearEditionPublished\" <= 3000)");
                    table.CheckConstraint("CK_Books_YearFirstPublished", "\"YearFirstPublished\" >= 1000 AND \"YearFirstPublished\" <= 3000");
                    table.ForeignKey(
                        name: "FK_Books_Borrowers_CurrentBorrowerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_BookLoans_ReturnedAfterCheckedOut", "\"ReturnedAtUtc\" IS NULL OR \"ReturnedAtUtc\" >= \"CheckedOutAtUtc\"");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookLoans_BookId_ReturnedAtUtc",
                table: "BookLoans",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookPhotos_BookId_SortOrder",
                table: "BookPhotos",
